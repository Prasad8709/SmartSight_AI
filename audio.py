...
GEMINI_API_KEY = "AIzaSyBcQd7u-SB0dwan-AW5WDFoDn35WHnHyR0"  # Replace with your valid API key
...
# Main Title
st.markdown('<div class="main-title"> 👁️‍🗨️ Redefining Smart City Infrastructure 👁️‍🗨️</div>', unsafe_allow_html=True)
...
# Sidebar Features
# st.sidebar.image(
#     r"C:\Users\saidu\Downloads\hello.jpg"
#     width=250
# )
st.sidebar.image(
    r"C:\Users\saidu\Downloads\hello.jpg",
